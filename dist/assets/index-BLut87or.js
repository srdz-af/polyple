...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:_i,depthTest:!1,depthWrite:!1})}function yc(){return new Xi({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:el(),fragmentShader:`
		...
		`,blending:_i,depthTest:!1,depthWrite:!1})}function bc(){return new Xi({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:el(),fragmentShader:`
...
`)}function v_(i,e){const t={},n=i.getProgramParameter(e,i.ACTIVE_ATTRIBUTES);for(let r=0;r<n;r++){const s=i.getActiveAttrib(e,r),a=s.name;let o=1;s.type===i.FLOAT_MAT2&&(o=2),s.type===i.FLOAT_MAT3&&(o=3),s.type===i.FLOAT_MAT4&&(o=4),t[a]={type:s.type,location:i.getAttribLocation(e,a),locationSize:o}}return t}function Mr(i){return i!==""}function Ic(i,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function Uc(i,e){return i.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const M_=/^[ \t]*#include +<([\w\d./]+)>/gm;function Da(i){return i.replace(M_,E_)}const S_=new Map([["encodings_fragment","colorspace_fragment"],["encodings_pars_fragment","colorspace_pars_fragment"],["output_fragment","opaque_fragment"]]);function E_(i,e){let t=We[e];if(t===void 0){const n=S_.get(e);if(n!==void 0)t=We[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return Da(t)}const y_=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Nc(i){return i.replace(y_,b_)}function b_(i,e,t,n){let r="";for(let s=parseInt(e);s<parseInt(t);s++)r+=n.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return r}function Fc(i){let e="precision "+i.precision+` float;
precision `+i.precision+" int;";return i.precision==="highp"?e+=`
#define HIGH_PRECISION`:i.precision==="mediump"?e+=`
#define MEDIUM_PRECISION`:i.precision==="lowp"&&(e+=`
#define LOW_PRECISION`),e}function T_(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===Ru?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===Qd?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===qn&&(e="SHADOWMAP_TYPE_VSM"),e}function A_(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case wr:case Rr:e="ENVMAP_TYPE_CUBE";break;case go:e="ENVMAP_TYPE_CUBE_UV";break}return e}function w_(i){let e="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case Rr:e="ENVMAP_MODE_REFRACTION";break}return e}function R_(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case Cu:e="ENVMAP_BLENDING_MULTIPLY";break;case yh:e="ENVMAP_BLENDING_MIX";break;case bh:e="ENVMAP_BLENDING_ADD";break}return e}function C_(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function P_(i,e,t,n){const r=i.getContext(),s=t.defines;let a=t.vertexShader,o=t.fragmentShader;const l=T_(t),c=A_(t),u=w_(t),d=R_(t),h=C_(t),m=t.isWebGL2?"":g_(t),g=__(t),_=x_(s),p=r.createProgram();let f,y,x=t.glslVersion?"#version "+t.glslVersion+`
...
void main() {
  ...
  `}function In(){if(!Ws)return;const i=[...Le>0?[{idx:-1,label:Ir,dimension:Ai||H.N,visible:Un}]:[],...ge.map((s,a)=>({idx:a,label:s.label,dimension:s.originalN,visible:s.visible}))];Ws.textContent="";const e=document.createElement("h4");e.textContent="Objects",Ws.appendChild(e);const t=document.createElement("table"),n=document.createElement("thead");n.innerHTML='<tr><th></th><th aria-label="Object name"></th><th>Dim</th></tr>',t.appendChild(n);const r=document.createElement("tbody");i.forEach(s=>{const a=document.createElement("tr");a.className=`object-row${s.idx===ke?" active":""}${s.visible?"":" hidden"}`,a.addEventListener("click",()=>wi(s.idx));const o=document.createElement("td"),l=document.createElement("button");l.className="object-eye",l.type="button",l.title=s.visible?"Hide object":"Show object",l.setAttribute("aria-label",s.visible?`Hide ${s.label}`:`Show ${s.label}`),l.innerHTML=Xx(s.visible),l.addEventListener("click",h=>{h.stopPropagation(),kx(s.idx,!s.visible)}),o.appendChild(l);const c=document.createElement("td"),u=document.createElement("input");u.className="object-name",u.value=s.label,u.title="Rename object",u.addEventListener("click",h=>h.stopPropagation()),u.addEventListener("keydown",h=>{h.stopPropagation(),h.key==="Enter"?(h.preventDefault(),u.blur()):h.key==="Escape"&&(u.value=s.label,u.blur())}),u.addEventListener("blur",()=>Wx(s.idx,u.value)),c.appendChild(u);const d=document.createElement("td");d.textContent=`${s.dimension}`,a.append(o,c,d),r.appendChild(a)}),t.appendChild(r),Ws.appendChild(t),cs()}function Yx(i){return`#${Math.max(0,Math.min(16777215,i>>>0)).toString(16).padStart(6,"0")}`}function Pd(i){if(i===ln)return Le>0?{surface:ei,renderer:Pe}:null;const e=ge[i];return e?{surface:e.surface,renderer:e.renderer}:null}function qx(i){Jt&&(Jt.disabled=!i),nn&&(nn.disabled=!i),rn&&(rn.disabled=!i),sn&&(sn.disabled=!i)}function Ld(i){!Jt||!nn||!rn||!sn||(Ha=!0,Jt.value=Yx(i.color),nn.value=`${i.metalness}`,rn.value=`${i.roughness}`,sn.value=`${i.alpha}`,so&&(so.textContent=Jt.value),oo&&(oo.textContent=i.metalness.toFixed(3)),ao&&(ao.textContent=i.roughness.toFixed(3)),lo&&(lo.textContent=i.alpha.toFixed(3)),Ha=!1)}function jx(){if(!es||Er)return;const i=new tl({canvas:es,antialias:!0,alpha:!0});i.setPixelRatio(Math.min(window.devicePixelRatio,2)),i.outputColorSpace=Dt,i.toneMapping=ot.toneMapping,i.toneMappingExposure=ot.toneMappingExposure,i.useLegacyLights=ot.useLegacyLights,i.setClearColor(0,0);const e=new nl;e.environment=$e.environment;const t=new on(36,1,.1,10);t.position.set(1.8,1.35,1.9),t.lookAt(0,0,0);const n=new io({color:hn.color,metalness:hn.metalness,roughness:hn.roughness,transparent:!1,opacity:hn.alpha,envMapIntensity:1.8,side:Cn}),r=new ut(new $i(1,1,1),n);r.rotation.set(.45,.68,0),e.add(r);const s=new ld(16777215,co.intensity);s.position.copy(co.position);const a=new cd(16777215,Md.intensity),o=new od($s.color.getHex(),$s.groundColor.getHex(),$s.intensity);e.add(a,o,s),Er=i,Ga=e,Zr=t,Va=r}function Ya(i){if(jx(),!Er||!Ga||!Zr||!Va||!es)return;const e=Math.max(1,es.clientWidth),t=Math.max(1,es.clientHeight);if(Er.setSize(e,t,!1),Zr.aspect=e/t,Zr.updateProjectionMatrix(),!i){Er.clear();return}const n=Va.material;n.color.setHex(i.color),n.metalness=i.metalness,n.roughness=i.roughness,n.transparent=i.alpha<.999,n.opacity=i.alpha,n.depthWrite=!n.transparent,n.needsUpdate=!0,Er.render(Ga,Zr)}function bo(){if(!js)return;const i=Pd(ke),e=!!i;js.classList.toggle("empty",!i),js.classList.toggle("disabled",!e),qx(e),i?(Ld(i.surface),Ya(i.surface)):Ya(null)}function ci(i){if(Ha)return;const e=Pd(ke);if(!e||!Jt||!nn||!rn||!sn)return;const t=ll({color:Number.parseInt(Jt.value.replace("#",""),16),metalness:Number.parseFloat(nn.value),roughness:Number.parseFloat(rn.value),alpha:Number.parseFloat(sn.value)}),n=e.surface;if(n.color!==t.color||Math.abs(n.metalness-t.metalness)>1e-6||Math.abs(n.roughness-t.roughness)>1e-6||Math.abs(n.alpha-t.alpha)>1e-6){if(i&&Hn(),ke===ln)ei=t,Pe.setSurface(ei),Pe.refreshSurface();else{const s=ge[ke];if(!s)return;s.surface=t,s.renderer.setSurface(s.surface),s.renderer.refreshSurface()}Ld(t),Ya(t)}}function $x(){js&&(Jt==null||Jt.addEventListener("input",()=>{so&&Jt&&(so.textContent=Jt.value),ci(!1)}),nn==null||nn.addEventListener("input",()=>{oo&&nn&&(oo.textContent=Number.parseFloat(nn.value).toFixed(3)),ci(!1)}),rn==null||rn.addEventListener("input",()=>{ao&&rn&&(ao.textContent=Number.parseFloat(rn.value).toFixed(3)),ci(!1)}),sn==null||sn.addEventListener("input",()=>{lo&&sn&&(lo.textContent=Number.parseFloat(sn.value).toFixed(3)),ci(!1)}),Jt==null||Jt.addEventListener("change",()=>ci(!0)),nn==null||nn.addEventListener("change",()=>ci(!0)),rn==null||rn.addEventListener("change",()=>ci(!0)),sn==null||sn.addEventListener("change",()=>ci(!0)))}function Zx(){const i=ol.geometry.getAttribute("color");if(!i)return;const e=new Xe(an[H.axesX%an.length]),t=new Xe(an[H.axesY%an.length]),n=new Xe(an[H.axesZ%an.length]);i.setXYZ(0,e.r,e.g,e.b),i.setXYZ(1,e.r,e.g,e.b),i.setXYZ(2,t.r,t.g,t.b),i.setXYZ(3,t.r,t.g,t.b),i.setXYZ(4,n.r,n.g,n.b),i.setXYZ(5,n.r,n.g,n.b),i.needsUpdate=!0}function $n(i){return["X","Y","Z","W","V","U","T","S"][i]??`D${i}`}function cs(){if(Zx(),!Au)return;const i=Vt(),e=Array.from({length:i}).map((t,n)=>`<span class="badge" style="background:${an[n%an.length]};">${$n(n)}</span>`).join("");Au.innerHTML=`<h4 style="margin:0 0 6px 0; font-size:12px; color:#e6ecf5;">Axes</h4><div>${e}</div>`}function us(){if(!$r)return;const i=Vt();if(i<1){$r.innerHTML="";return}const e=Lt.slice(0,i),t=new Set([e[(Mt+0)%i],e[(Mt+1)%i],e[(Mt+2)%i]]),n=e.map((s,a)=>{const o=an[s%an.length],l=t.has(s);return`<li draggable="true" data-idx="${a}" class="${l?"active":""}" style="--axis-color:${o};border-top:3px solid ${o};">${$n(s)}</li>`}).join("");$r.innerHTML=`
    ...
    <ul>${n}</ul>
  `;const r=$r.querySelector("#axis-cycle-button");r==null||r.addEventListener("click",()=>wd(1)),$r.querySelectorAll("li").forEach(s=>{s.addEventListener("dragstart",a=>{var o;(o=a.dataTransfer)==null||o.setData("text/plain",s.dataset.idx||"")}),s.addEventListener("dragover",a=>a.preventDefault()),s.addEventListener("drop",a=>{var d;a.preventDefault();const o=Number(((d=a.dataTransfer)==null?void 0:d.getData("text/plain"))??-1),l=Number(s.dataset.idx??-1);if(o<0||l<0||o===l)return;const c=Lt.splice(o,1)[0];Lt.splice(l,0,c);const u=Lt.slice(0,Vt()).indexOf(H.axesX);Mt=u>=0?u:0,Ad({x:Lt[Mt%Vt()],y:Lt[(Mt+1)%Vt()],z:Lt[(Mt+2)%Vt()]}),us()})})}function wi(i){let e=i;e===ln&&Le<=0&&(e=gi),e>=0&&!ge[e]&&(e=gi),e<gi&&(e=gi),ke=e,zn=-1,On=!1,In(),At&&($e.remove(At),At=null);const t=n=>{const r=new Yi({color:16754253,transparent:!0,opacity:1,depthTest:!1,depthWrite:!1}),s=new Mo(n,r);return s.renderOrder=10,s};if(e===ln)Le>0&&(At=t(Pe.line.geometry));else if(e>=0){const n=ge[e];At=t(n.renderer.line.geometry)}At&&!H.editMode&&ti(e)&&$e.add(At),Zi(H.editMode),pt&&($e.remove(pt),pt=null),xt&&($e.remove(xt),xt=null),H.editMode&&ti(e)&&To(e),bo(),Br()}function ds(){if(At){if(H.editMode||!ti(ke)){$e.remove(At),At=null;return}$e.children.includes(At)||$e.add(At)}}function hl(){zi&&($e.remove(zi),zi.geometry.dispose(),zi=null),Hi&&($e.remove(Hi),Hi.geometry.dispose(),Hi=null)}function qa(i,e){if(!e)return new w;let t=0,n=0,r=0;for(let s=0;s<e;s++){const a=s*3;t+=i[a],n+=i[a+1],r+=i[a+2]}return new w(t/e,n/e,r/e)}function Dd(i,e,t){const n=i===-1?null:ge[i],r=n?n.X:kt,s=n?n.M:Le,a=n?n.Y:mi,o=n?n.transform:Ct,l=n?n.originalN:Ai||Vt(),c=n?n.axisMap:Or;if(e<0||e>=s)return!1;const u=n?n.renderer.positions:Pe.positions,d=e*3;Mu.set(o.rot.x,o.rot.y,o.rot.z),vu.setFromEuler(Mu),va.compose(Hx,vu,o.scale),Su.copy(va).invert(),Eu.set(u[d],u[d+1],u[d+2]),yu.set(a[e],a[s+e],a[2*s+e]),Tu.copy(yu).applyMatrix4(va),bu.copy(Eu).sub(Tu),Ui.copy(t).sub(bu).applyMatrix4(Su);const h=yi.matrix;for(let x=0;x<ze;x++){let b=0;for(let L=0;L<ze;L++)b+=h[x*ze+L]*r[L*s+e];xu[x]=b,ks[x]=b}const m=[H.axesX%ze,H.axesY%ze,H.axesZ%ze].map(x=>Math.max(0,Math.min(ze-1,x))),g=dl(l,c),_=.6;let p=g>=0?xu[g]??0:0;const f=g>=0?m.indexOf(g):-1;if(f>=0){const x=f===0?Ui.x:f===1?Ui.y:Ui.z,b=1+_*x;Math.abs(b)>1e-6&&(p=x/b)}const y=g>=0?1/Math.max(.05,1-_*p):1;for(let x=0;x<3;x++){const b=m[x],L=x===0?Ui.x:x===1?Ui.y:Ui.z;g>=0&&b===g?ks[b]=p:ks[b]=L/y}for(let x=0;x<ze;x++){let b=0;for(let L=0;L<ze;L++)b+=h[L*ze+x]*ks[L];r[x*s+e]=b}return!0}function ho(){if(hl(),I.mode==="none")return;const i=I.lockAxis!==-1,e=i?I.lockAxis:0,t=new w(e===0?1:0,e===1?1:0,e===2?1:0);if(!i&&!I.wPlane)return;let n=new w;if(I.targetVertex>=0){const a=I.instIdx===-1?null:ge[I.instIdx],o=a?a.renderer.positions:Pe.positions,l=I.targetVertex*3;n.set(o[l],o[l+1],o[l+2])}else if(I.instIdx===-1&&Le>0)n=qa(Pe.positions,Le);else if(I.instIdx>=0){const a=ge[I.instIdx];n=qa(a.renderer.positions,a.M)}const r=3,s=[n.clone().addScaledVector(t,-r),n.clone().addScaledVector(t,r)];if(i){const a=new $t().setFromPoints(s),o=new Yi({color:16754253,linewidth:2,depthTest:!1,transparent:!0,opacity:.9});zi=new Ia(a,o),zi.renderOrder=30,$e.add(zi)}if(I.wPlane){const a=new w(0,0,0);a.copy(t).cross(st.getWorldDirection(vt).normalize()).normalize(),a.lengthSq()===0&&a.copy(st.up).normalize();const o=2,l=[n.clone().addScaledVector(a,-o),n.clone().addScaledVector(a,o)],c=new $t().setFromPoints(l),u=new Yi({color:12616956,linewidth:2,depthTest:!1,transparent:!0,opacity:.9});Hi=new Ia(c,u),Hi.renderOrder=31,$e.add(Hi)}}function To(i){if(!H.editMode||!ti(i)){xt&&($e.remove(xt),xt=null),pt&&($e.remove(pt),pt=null);return}const e=i===-1?Pe:ge[i].renderer,t=i===-1?Le:ge[i].M;if(!e||t<=0)return;xt&&($e.remove(xt),xt=null);const n=new as({color:12568533});xt=new sx(Sd,n,t);const r=new It,s=e.positions;for(let a=0;a<t;a++){const o=a*3;r.position.set(s[o],s[o+1],s[o+2]),r.updateMatrix(),xt.setMatrixAt(a,r.matrix)}xt.instanceMatrix.needsUpdate=!0,xt.renderOrder=5,$e.add(xt),zn>=0&&fl(i,zn)}function fl(i,e){if(!ti(i))return;if(!pt){const s=new as({color:16754253,depthTest:!1});pt=new ut(Sd,s),pt.renderOrder=20}pt.scale.setScalar(1.35);const n=(i===-1?Pe:ge[i].renderer).positions,r=e*3;pt.position.set(n[r],n[r+1],n[r+2]),$e.add(pt)}function Id(){if(ke<0)return;Hn(),ge[ke].renderer.dispose(),ge.splice(ke,1),ke=gi,At&&($e.remove(At),At=null),On=!1,mn(),En(),In(),wi(ke)}const ge=[];function Kx(i){const e=new ls($e);e.build(i.M,i.E);const t=ll(i.surface);return e.setSurface(t),e.setMode(H.renderMode),{renderer:e,Y:new Float32Array(3*i.M),X:new Float32Array(i.X),E:new Uint32Array(i.E),M:i.M,offset:i.offset.clone(),label:i.label,kind:i.kind,transform:Wa(i.transform),originalN:i.originalN,axisMap:bd(i.axisMap,i.originalN),visible:i.visible,surface:t}}const Pe=new ls($e);Le>0&&(Pe.build(Le,Dr),Pe.setMode("wireframe"));const H={N:4,primitive:"hypercube",projection:"Canonical",sliceDim:-1,sliceMin:-.5,sliceMax:.5,renderMode:"wireframe",editMode:!1,autoSpin:!1,axesX:0,axesY:1,axesZ:2};Ix();const Jx=i=>({...i,_lastTheta:i._lastTheta??0}),Qx=[{i:0,j:1,theta:0,auto:!0,speed:.45},{i:2,j:3,theta:0,auto:!0,speed:.31},{i:4,j:5,theta:0,auto:!0,speed:.18}],pl=Qx.map(Jx);function e0(){pl.forEach(i=>{i.i=Math.min(i.i,ze-1),i.j=Math.min(i.j,ze-1),i.theta=0,i._lastTheta=0})}function ss(){lu&&(lu.textContent=`${H.N}D`),Jr&&(Jr.disabled=H.N<=3),Qr&&(Qr.disabled=H.N>=zt)}function fo(i){if(!Number.isFinite(i)){ss();return}const e=Math.max(3,Math.min(zt,Math.round(i)));H.N=e;const t=Vt();Mt=(Mt%t+t)%t;const n=Lt.slice(0,t);H.axesX=n[Mt%t]??0,H.axesY=n[(Mt+1)%t]??1,H.axesZ=n[(Mt+2)%t]??2,ss(),us(),cs()}function Ud(){Tr&&(Tr.classList.toggle("active",H.editMode),Tr.setAttribute("aria-pressed",String(H.editMode)))}function Nd(i){H.editMode=i,Zi(H.editMode),Ud(),zn=-1,pt&&($e.remove(pt),pt=null),H.editMode?To(ke):xt&&($e.remove(xt),xt=null),ds(),Br()}function Br(){const i=[{mode:"move",el:fd},{mode:"rotate",el:pd},{mode:"scale",el:md}],e=ti(ke),t=I.mode!=="none";for(const n of i)n.el&&(n.el.classList.toggle("active",I.mode===n.mode),n.el.disabled=!e||t)}function Fd(i){xr=i,document.body.classList.toggle("pane-collapsed",xr),Bi&&(Bi.setAttribute("aria-expanded",String(!xr)),Bi.setAttribute("aria-label",xr?"Show panel details":"Hide panel details"),Bi.title=xr?"Show panel details":"Hide panel details")}function t0(){{const i=Vt(),e=[H.axesX%i,H.axesY%i,H.axesZ%i].map(n=>Math.max(0,Math.min(i-1,n))),t=new Float32Array(3*ze);t[0*ze+e[0]]=1,t[1*ze+e[1]]=1,t[2*ze+e[2]]=1,Qn.setCustomP(t)}}function En(){Le>0&&Pe.geometry&&Pe.filterEdgesByDimRange(kt,ze,Le,H.sliceDim,H.sliceMin,H.sliceMax),ge.forEach(i=>{i.renderer.filterEdgesByDimRange(i.X,ze,i.M,H.sliceDim,H.sliceMin,H.sliceMax)}),ds(),Zi(H.editMode),H.editMode?To(ke):xt&&($e.remove(xt),xt=null)}function Sa(i,e){if(e===0)return _u.set(0,0,0);let t=0,n=0,r=0;for(let l=0;l<e;l++)t+=i[l],n+=i[e+l],r+=i[2*e+l];const s=t/e,a=n/e,o=r/e;for(let l=0;l<e;l++)i[l]-=s,i[e+l]-=a,i[2*e+l]-=o;return _u.set(s,a,o)}function mn(){if(ze>=4){const e=[H.axesX%ze,H.axesY%ze,H.axesZ%ze].map(r=>Math.max(0,Math.min(ze-1,r))),t=.6,n=(r,s,a,o,l,c,u)=>{if(s===0)return;const d=ze,h=yi.matrix,m=dl(c,u);for(let p=0;p<s;p++){for(let x=0;x<d;x++){let b=0;for(let L=0;L<d;L++)b+=h[x*d+L]*r[L*s+p];jr[x]=b}const f=m>=0?jr[m]??0:0,y=m>=0?1/Math.max(.05,1-t*f):1;a[0*s+p]=jr[e[0]]*y,a[1*s+p]=jr[e[1]]*y,a[2*s+p]=jr[e[2]]*y}const g=Sa(a,s),_=vt.set(o.pos.x+g.x,o.pos.y+g.y,o.pos.z+g.z);l.setTransform(_,new Dn(o.rot.x,o.rot.y,o.rot.z),o.scale),l.writeInterleavedFrom(a),l.refreshSurface()};Le>0&&Pe.geometry&&n(kt,Le,mi,Ct,Pe,Ai||Vt(),Or),ge.forEach(r=>{n(r.X,r.M,r.Y,r.transform,r.renderer,r.originalN,r.axisMap)})}else{if(t0(),Le>0&&Pe.geometry){Qn.project(kt,Le,mi);const e=Sa(mi,Le),t=vt.set(Ct.pos.x+e.x,Ct.pos.y+e.y,Ct.pos.z+e.z);Pe.setTransform(t,new Dn(Ct.rot.x,Ct.rot.y,Ct.rot.z),Ct.scale),Pe.writeInterleavedFrom(mi),Pe.refreshSurface()}ge.forEach(e=>{Qn.project(e.X,e.M,e.Y);const t=Sa(e.Y,e.M),n=vt.set(e.transform.pos.x+t.x,e.transform.pos.y+t.y,e.transform.pos.z+t.z);e.renderer.setTransform(n,new Dn(e.transform.rot.x,e.transform.rot.y,e.transform.rot.z),e.transform.scale),e.renderer.writeInterleavedFrom(e.Y),e.renderer.refreshSurface()})}Cd(),ds(),H.editMode&&To(ke),ho()}function Od(){if(!ui)return;const i=H.autoSpin;ui.classList.toggle("active",i),ui.setAttribute("aria-pressed",String(i)),ui.setAttribute("aria-label",i?"Stop auto rotation":"Start auto rotation"),ui.title=i?"Stop auto rotation":"Start auto rotation"}function n0(){yi.reset(),pl.forEach(i=>{i.theta=0,i._lastTheta=0}),Ei=-Math.PI/4,Zi(H.editMode)}function Bd(i){const e=H.autoSpin;H.autoSpin=i,e&&!i&&(n0(),mn(),En()),Od()}function i0(i){if(!H.autoSpin)return;const e=Vt();let t=!1,n=0;const r=sl();for(const s of pl){if(!s.auto||s.speed===0||s.i===s.j||s.i>=e||s.j>=e)continue;const a=s.speed*i;s.theta+=a,yi.applyGivensLeft(s.i,s.j,a),r&&(s.i===r.wDim||s.j===r.wDim)&&(n+=s.i===r.wDim?-a:a),t=!0}t&&Math.abs(n)>1e-6&&(Ei=Oa(Ei+n),Zi(H.editMode))}function zd(i){if(!tt)return;On=!0,tt.innerHTML="";const e=document.createElement("div");e.textContent="Delete?",e.style.padding="8px 12px",e.style.fontWeight="700",tt.appendChild(e);const t=document.createElement("button");t.textContent="Confirm",t.onclick=()=>{tt.style.display="none",On=!1,Id()};const n=document.createElement("button");n.textContent="Cancel",n.onclick=()=>{On=!1,tt.style.display="none"},tt.appendChild(t),tt.appendChild(n);const r=(i==null?void 0:i.clientX)??Mn.x,s=(i==null?void 0:i.clientY)??Mn.y;tt.style.left=`${r}px`,tt.style.top=`${s}px`,tt.style.display="block"}function r0(){ge.forEach(i=>i.renderer.dispose()),ge.length=0,ke=gi}function s0(i,e=!0){e&&Hn();let t;if(Le>0&&Un)t={verts:new Float32Array(kt),edges:new Uint32Array(Dr),V:Le,kind:H.primitive,axisMap:[...Or],originalN:Ai||H.N};else{const l=rl(H.primitive,H.N),c=ul(H.N);t={verts:yo(l.verts,H.N,c),edges:l.edges,V:l.V,kind:H.primitive,axisMap:c,originalN:H.N}}const n=new ls($e);n.build(t.V,t.edges);const r=Le>0&&Un?Ti(ei):Ti(hn);n.setSurface(r);const s=new Float32Array(3*t.V),a=`${t.kind} #${ge.length+1}`,o={pos:i.clone(),rot:new w,scale:new w(1,1,1)};ge.push({renderer:n,Y:s,X:t.verts,E:t.edges,M:t.V,offset:i.clone(),label:a,kind:t.kind,transform:o,originalN:t.originalN,axisMap:[...t.axisMap],visible:!0,surface:r}),Qn.project(t.verts,t.V,s),n.setTransform(o.pos,new Dn(o.rot.x,o.rot.y,o.rot.z),o.scale),n.writeInterleavedFrom(s),n.filterEdgesByDimRange(t.verts,zt,t.V,H.sliceDim,H.sliceMin,H.sliceMax),n.setMode(H.renderMode),mn(),En(),bi&&bi(H.renderMode),In()}function Hd(i,e,t,n,r,s){var l;Bd(!1),Pt.active=!1,St.enableZoom=!0,St.enablePan=!0,St.enableRotate=!0,St.enabled=!0,St.reset(),st.position.set(2.6,1.8,2.6);const a=H.renderMode;Ed=n;const o=zt;ze=o,H.N=Math.min(H.N,zt),kt=new Float32Array(e),Dr=t.length?new Uint32Array(t):yd,Le=Math.floor(e.length/o),yi=new ud(o),Qn=new dd(o,yi.matrix,ro(o)),mi=new Float32Array(3*Le),r0(),Un=!0,Ct.pos.set(0,0,0),Ct.rot.set(0,0,0),Ct.scale.set(1,1,1),Ai=r??Vt(),Or=bd(s,Ai),ei=Ti(hn),Lt=Array.from({length:ze},(c,u)=>u),Mt=0,H.axesX=Lt[0]??0,H.axesY=Lt[1]??1,H.axesZ=Lt[2]??2,e0(),H.sliceDim>=o&&(H.sliceDim=o-1),Le>0?(Pe.build(Le,Dr),Pe.setSurface(ei),Pe.setMode(H.renderMode),bi&&bi(a),mn(),En()):(l=Pe.dispose)==null||l.call(Pe),ss(),Ir=n==="custom"?"Custom":"Hypercube",In(),wi(ln),cs(),us()}function o0(i,e,t="text/plain"){const n=new Blob([e],{type:t}),r=URL.createObjectURL(n),s=document.createElement("a");s.href=r,s.download=i,s.click(),URL.revokeObjectURL(r)}async function a0(i){try{const e=await i.text(),t=Ex(e);if(t.N<3||t.N>8){alert("Only datasets between 3 and 8 dimensions can be visualized.");return}Hn(),H.N=t.N;const n=cl(t.N),r=yo(t.X,t.N,n),s=t.edges.length?t.edges:yd;Hd(zt,r,s,"custom",t.N,n)}catch(e){console.error(e),alert(`Import failed: ${e.message}`)}finally{Mi&&(Mi.value="")}}function l0(){const{Xsrc:i,count:e,Esrc:t}=c0();if(e===0){alert("No data to export");return}o0("data.json",yx(i,e,ze,t),"application/json")}function c0(){if(ke>=0&&ge[ke]){const i=ge[ke];return{Xsrc:i.X,count:i.M,Esrc:i.E}}return Le>0?{Xsrc:kt,count:Le,Esrc:Dr}:{Xsrc:new Float32Array,count:0,Esrc:new Uint32Array}}function u0(i,e,t,n){const r=[];for(let s=0;s<i;s++){const a=e[s*t+n];r.push(`d${s}: ${a.toFixed(3)}`)}return r}function Gd(i){const e=ot.domElement.getBoundingClientRect();return pi.set((i.clientX-e.left)/e.width*2-1,-((i.clientY-e.top)/e.height)*2+1),fu.setFromNormalAndCoplanarPoint(st.getWorldDirection(vt).normalize(),St.target),fi.setFromCamera(pi,st),fi.ray.intersectPlane(fu,pu)?pu.clone():St.target.clone()}function d0(i){if(!jn)return;const e=ot.domElement.getBoundingClientRect(),t=i.clientX-e.left,n=i.clientY-e.top,r=e.width,s=e.height;let a=-1,o=Number.POSITIVE_INFINITY;const l=(d,h,m,g,_)=>{vt.set(d,h,m).project(st);const p=(vt.x*.5+.5)*r,f=(-vt.y*.5+.5)*s,y=p-t,x=f-n,b=y*y+x*x;b<o&&(o=b,a=g,c=_)};let c=-1;if(Un)for(let d=0;d<Le;d++){const h=d*3;l(Pe.positions[h],Pe.positions[h+1],Pe.positions[h+2],d,-1)}ge.forEach((d,h)=>{if(!d.visible)return;const m=d.renderer.positions;for(let g=0;g<d.M;g++){const _=g*3;l(m[_],m[_+1],m[_+2],g,h)}});const u=30*30;if(a>=0&&o<u){const d=c>=0&&ge[c]?{coords:ge[c].X,count:ge[c].M}:{coords:kt,count:Le},h=u0(ze,d.coords,d.count,a);jn.innerHTML=`<div style="font-weight:600;margin-bottom:4px;">v${a}</div><div>${h.join("<br>")}</div>`,jn.style.left=`${i.clientX}px`,jn.style.top=`${i.clientY}px`,jn.classList.add("visible")}else jn.classList.remove("visible");if(Kn&&I.mode==="none"){const d=(i.clientX-e.left)/e.width*2-1,h=-((i.clientY-e.top)/e.height)*2+1;Kn.textContent=`Cursor NDC: (${d.toFixed(3)}, ${h.toFixed(3)})`}}mn();En();cs();us();In();Zi(H.editMode);ss();Ud();$x();bo();if(au){const i=Array.from(au.querySelectorAll("button")),e=n=>gx.includes(n),t=()=>{i.forEach(n=>n.classList.toggle("active",n.dataset.mode===H.renderMode))};bi=n=>{H.renderMode=n,Pe.setMode(n),Pe.refreshSurface(),ge.forEach(r=>{r.renderer.setMode(n),r.renderer.refreshSurface()}),bo(),t()},i.forEach(n=>{n.addEventListener("click",()=>{e(n.dataset.mode)&&bi(n.dataset.mode)})}),t()}Le===0&&ge.length===0&&(s0(new w(0,0,0),!1),wi(0));Mi&&Mi.addEventListener("change",()=>{var e;const i=(e=Mi.files)==null?void 0:e[0];i&&a0(i)});ma==null||ma.addEventListener("click",()=>Mi==null?void 0:Mi.click());ga==null||ga.addEventListener("click",()=>l0());Tr==null||Tr.addEventListener("click",()=>Nd(!H.editMode));Bi==null||Bi.addEventListener("click",()=>Fd(!xr));[{el:fd,mode:"move"},{el:pd,mode:"rotate"},{el:md,mode:"scale"}].forEach(i=>{var e;(e=i.el)==null||e.addEventListener("pointerdown",t=>h0(i.mode,t))});Jr==null||Jr.addEventListener("click",()=>fo(H.N-1));Qr==null||Qr.addEventListener("click",()=>fo(H.N+1));_a==null||_a.addEventListener("keydown",i=>{i.stopPropagation(),i.key==="ArrowDown"||i.key==="ArrowLeft"||i.key==="-"||i.key==="_"?(i.preventDefault(),fo(H.N-1)):(i.key==="ArrowUp"||i.key==="ArrowRight"||i.key==="+"||i.key==="=")&&(i.preventDefault(),fo(H.N+1))});ui==null||ui.addEventListener("click",()=>Bd(!H.autoSpin));Od();Br();Fd(!1);function Vd(i,e){if(I.mode==="none")return;const t=i-I.startMouse.x,n=e-I.startMouse.y;if(I.targetVertex>=0){const r=I.instIdx===-1?null:ge[I.instIdx];r?r.renderer.positions:Pe.positions;const s=I.targetVertex*3,a=ot.domElement.getBoundingClientRect();pi.set((i-a.left)/a.width*2-1,-((e-a.top)/a.height)*2+1),fi.setFromCamera(pi,st),I.plane.setFromNormalAndCoplanarPoint(st.getWorldDirection(vt).normalize(),I.planeHitStart);const o=fi.ray.intersectPlane(I.plane,vt);if(!o)return;const l=za;if(I.mode==="move"){const u=I.lockAxis;l.set(u===1||u===2?I.vertexStart.x:o.x,u===0||u===2?I.vertexStart.y:o.y,u===0||u===1?I.vertexStart.z:o.z),I.lastHit.copy(l)}else if(I.mode==="scale"){const u=o.clone().sub(I.planeHitStart),d=I.vertexStart.clone().sub(I.planeHitStart),h=d.length(),m=u.length(),g=h>1e-6?m/h:1,_=d.multiplyScalar(g).add(I.planeHitStart);l.copy(_),I.lastHit.copy(_)}else if(I.mode==="rotate"){const u=I.vertexStart.clone().sub(I.planeHitStart),d=o.clone().sub(I.planeHitStart),h=Math.atan2(d.y,d.x)-Math.atan2(u.y,u.x),m=new Bn().setFromAxisAngle(I.axis,h);u.applyQuaternion(m).add(I.planeHitStart),l.copy(u),I.lastHit.copy(u)}else return;if(!Dd(I.instIdx,I.targetVertex,l))return;mn(),En();const c=r?r.renderer.positions:Pe.positions;pt&&pt.position.set(c[s],c[s+1],c[s+2]),Kn&&(Kn.textContent=`Vertex (${I.targetVertex}): (${c[s].toFixed(3)}, ${c[s+1].toFixed(3)}, ${c[s+2].toFixed(3)})`)}else{const r=I.instIdx===-1?Ct:ge[I.instIdx].transform;if(I.mode==="move"){const s=I.instIdx===-1?kt:ge[I.instIdx].X,a=I.objectDataStart,o=I.instIdx===-1?Le:ge[I.instIdx].M;if(a&&o>0){const l=ot.domElement.getBoundingClientRect();pi.set((i-l.left)/l.width*2-1,-((e-l.top)/l.height)*2+1),fi.setFromCamera(pi,st);const c=fi.ray.intersectPlane(I.plane,vt);if(!c)return;const u=c.clone().add(I.moveOffset).sub(I.planeHitStart);I.lockAxis===0?(u.y=0,u.z=0):I.lockAxis===1?(u.x=0,u.z=0):I.lockAxis===2&&(u.x=0,u.y=0);const d=[H.axesX,H.axesY,H.axesZ];for(let h=0;h<o;h++)for(let m=0;m<3;m++){const _=d[m]%ze*o+h;s[_]=a[_]+u.getComponent(m)}I.lastHit.copy(c)}}else if(I.mode==="rotate")if(I.wPlane&&I.objectDataStart){const s=I.instIdx===-1?null:ge[I.instIdx],a=s?s.X:kt,o=I.objectDataStart,l=s?s.M:Le;if(l>0){const c=s?s.originalN:Ai||Vt(),u=s?s.axisMap:Or,d=dl(c,u),h=Td(I.lockAxis,d);if(h<0||d<0||h===d)return;const m=(t-n)*.01,g=Math.cos(m),_=Math.sin(m);for(let p=0;p<l;p++){const f=o[h*l+p],y=o[d*l+p];a[h*l+p]=f*g-y*_,a[d*l+p]=f*_+y*g}}}else{const s=t*.005,a=n*.005,o=I.startRot.x,l=I.startRot.y,c=I.startRot.z;I.lockAxis===0?r.rot.set(o+a,l,c):I.lockAxis===1?r.rot.set(o,l+s,c):I.lockAxis===2?r.rot.set(o,l,c+s):r.rot.set(o+a,l+s,c)}else if(I.mode==="scale"){const s=(t-n)*.005,a=Math.max(.1,Math.min(5,I.startScale+s));r.scale.set(a,a,a)}Kn&&(Kn.textContent=`Object: pos(${r.pos.x.toFixed(3)}, ${r.pos.y.toFixed(3)}, ${r.pos.z.toFixed(3)}) rot(${r.rot.x.toFixed(3)}, ${r.rot.y.toFixed(3)}, ${r.rot.z.toFixed(3)})`)}mn(),En(),ds(),ho()}function po(i){if(I.mode!=="none"){if(i){if(I.targetVertex>=0){const e=I.instIdx===-1?null:ge[I.instIdx],t=e?e.renderer.positions:Pe.positions,n=I.targetVertex*3;za.set(t[n],t[n+1],t[n+2]),Dd(I.instIdx,I.targetVertex,za)}if(Kn)if(I.targetVertex>=0){const e=I.instIdx===-1?null:ge[I.instIdx],t=e?e.renderer.positions:Pe.positions,n=I.targetVertex*3;Kn.textContent=`Vertex (${I.targetVertex}) commit: (${t[n].toFixed(3)}, ${t[n+1].toFixed(3)}, ${t[n+2].toFixed(3)})`}else{const e=I.instIdx===-1?Ct:ge[I.instIdx].transform;Kn.textContent=`Object commit: pos(${e.pos.x.toFixed(3)}, ${e.pos.y.toFixed(3)}, ${e.pos.z.toFixed(3)})`}}else if(I.targetVertex>=0){const e=I.instIdx===-1?null:ge[I.instIdx],t=e?e.renderer.positions:Pe.positions,n=I.targetVertex*3;t[n]=I.vertexStart.x,t[n+1]=I.vertexStart.y,t[n+2]=I.vertexStart.z;const r=e?e.renderer:Pe;if(I.vertexDataStart){const s=e?e.X:kt,a=e?e.M:Le;for(let o=0;o<ze;o++)s[o*a+I.targetVertex]=I.vertexDataStart[o]}e?(Qn.project(e.X,e.M,e.Y),e.renderer.writeInterleavedFrom(e.Y),e.renderer.filterEdgesByDimRange(e.X,ze,e.M,H.sliceDim,H.sliceMin,H.sliceMax)):(Qn.project(kt,Le,mi),Pe.writeInterleavedFrom(mi),Pe.filterEdgesByDimRange(kt,ze,Le,H.sliceDim,H.sliceMin,H.sliceMax)),r.geometry.getAttribute("position").needsUpdate=!0,r.geometry.computeBoundingBox(),r.geometry.computeBoundingSphere(),pt&&pt.position.set(t[n],t[n+1],t[n+2])}else{const e=I.instIdx===-1?Ct:ge[I.instIdx].transform;I.objectDataStart&&(I.instIdx===-1?kt:ge[I.instIdx].X).set(I.objectDataStart),e.pos.copy(I.startPos),e.rot.copy(I.startRot),e.scale.set(I.startScale,I.startScale,I.startScale)}I.mode="none",I.vertexDataStart=null,I.lockAxis=-1,I.objectDataStart=null,I.wPlane=!1,hl(),I.moveOffset.set(0,0,0),mn(),En(),H.editMode&&zn>=0&&fl(ke,zn),ds(),Br()}}function h0(i,e){var t;if(i!=="none"&&I.mode==="none"&&ti(ke)){e.preventDefault(),e.stopPropagation(),je.active=!0,je.started=!1,je.pointerId=e.pointerId,je.mode=i,je.startX=e.clientX,je.startY=e.clientY,je.sourceButton=e.currentTarget;try{(t=je.sourceButton)==null||t.setPointerCapture(e.pointerId)}catch{}}}const f0=new cx;ot.domElement.addEventListener("pointermove",d0);ot.domElement.addEventListener("pointermove",i=>{Mn={x:i.clientX,y:i.clientY},I.mode!=="none"&&(i.preventDefault(),Vd(i.clientX,i.clientY))});ot.domElement.addEventListener("pointerleave",()=>jn==null?void 0:jn.classList.remove("visible"));ot.domElement.addEventListener("contextmenu",i=>{if(!tt)return;i.preventDefault(),Mn={x:i.clientX,y:i.clientY},On=!1,tt.innerHTML="";const e=Gd(i);if(H.editMode){if(zn<0)return;[{label:"Move vertex",mode:"move"}].forEach(s=>{const a=document.createElement("button");a.textContent=s.label,a.onclick=()=>{tt.style.display="none",mo(s.mode,i)},tt.appendChild(a)})}else ke===ln&&Le>0||ke>=0?[{label:"Move",mode:"move"},{label:"Rotate",mode:"rotate"},{label:"Scale",mode:"scale"},{label:"Delete",onClick:()=>zd(i)}].forEach(a=>{const o=document.createElement("button");o.textContent=a.label,o.onclick=()=>{if(tt.style.display="none",a.onClick){a.onClick();return}mo(a.mode,i)},tt.appendChild(o)}):[{label:"Hypercube",kind:"hypercube"},{label:"Cross polytope",kind:"cross"},{label:"Simplex",kind:"simplex"},{label:"Simplex prism",kind:"simplexPrism"}].forEach(a=>{const o=document.createElement("button");o.textContent=`Add ${a.label}`,o.onclick=()=>{tt.style.display="none",Hn();const l=rl(a.kind,H.N),c=ul(H.N),u=yo(l.verts,H.N,c),d=new ls($e);d.build(l.V,l.edges),Ar.copy(e);const h=new Float32Array(3*l.V),m=`${a.label} #${ge.length+1}`,g={pos:Ar.clone(),rot:new w,scale:new w(1,1,1)},_=Ti(hn);d.setSurface(_),ge.push({renderer:d,Y:h,X:u,E:l.edges,M:l.V,offset:Ar.clone(),label:m,kind:a.kind,transform:g,originalN:H.N,axisMap:c,visible:!0,surface:_}),Qn.project(u,l.V,h),d.setTransform(g.pos,new Dn(g.rot.x,g.rot.y,g.rot.z),g.scale),d.writeInterleavedFrom(h),d.filterEdgesByDimRange(u,zt,l.V,H.sliceDim,H.sliceMin,H.sliceMax),d.setMode(H.renderMode),mn(),En(),bi&&bi(H.renderMode),In()},tt.appendChild(o)});const t=Math.min(i.clientX,window.innerWidth-180),n=Math.min(i.clientY,window.innerHeight-150);tt.style.left=`${t}px`,tt.style.top=`${n}px`,tt.style.display=tt.innerHTML?"block":"none"});window.addEventListener("click",()=>{On||(tt&&(tt.style.display="none"),On=!1)});ot.domElement.addEventListener("wheel",i=>{if(!H.editMode)return;i.preventDefault();const e=i.deltaY>0?1:-1;let t=H.sliceDim+e;t=Math.max(-1,Math.min(ze-1,t)),H.sliceDim=t,En()});ot.domElement.addEventListener("mousedown",i=>{if(i.button===1){i.preventDefault(),i.stopPropagation(),Pt.active=!0,Pt.lastX=i.clientX,Pt.accum=0,Pt.prevZoom=St.enableZoom,Pt.prevPan=St.enablePan,St.enableZoom=!1,St.enablePan=!1;return}},{capture:!0});ot.domElement.addEventListener("pointerdown",i=>{if(Pt.active)return;if(Mn={x:i.clientX,y:i.clientY},I.mode!=="none"){i.button===0?(Hn(),po(!0)):i.button===2&&po(!1),i.preventDefault();return}if(i.button!==0)return;const e=ot.domElement.getBoundingClientRect(),t=i.clientX-e.left,n=i.clientY-e.top,r=e.width,s=e.height,a=(u,d)=>{let h=1/0,m=1/0,g=-1/0,_=-1/0;for(let p=0;p<d;p++){const f=p*3;vt.set(u[f],u[f+1],u[f+2]).project(st);const y=(vt.x*.5+.5)*r,x=(-vt.y*.5+.5)*s;y<h&&(h=y),y>g&&(g=y),x<m&&(m=x),x>_&&(_=x)}return{minX:h,maxX:g,minY:m,maxY:_}},o=[];if(Le>0){const u=a(Pe.positions,Le),d=t>=u.minX&&t<=u.maxX&&n>=u.minY&&n<=u.maxY,h=(u.maxX-u.minX)*(u.maxY-u.minY);o.push({instIdx:-1,contains:d,area:h,nearestDist2:Number.POSITIVE_INFINITY})}ge.forEach((u,d)=>{if(!u.visible)return;const h=a(u.renderer.positions,u.M),m=t>=h.minX&&t<=h.maxX&&n>=h.minY&&n<=h.maxY,g=(h.maxX-h.minX)*(h.maxY-h.minY);o.push({instIdx:d,contains:m,area:g,nearestDist2:Number.POSITIVE_INFINITY})});let l=-1;const c=o.filter(u=>u.contains&&isFinite(u.area));if(c.length)c.sort((u,d)=>u.area-d.area),l=c[0].instIdx;else{let u=Number.POSITIVE_INFINITY;const d=(m,g,_,p)=>{vt.set(m,g,_).project(st);const f=(vt.x*.5+.5)*r,y=(-vt.y*.5+.5)*s,x=f-t,b=y-n,L=x*x+b*b;L<u&&(u=L,l=p)};if(Un)for(let m=0;m<Le;m++){const g=m*3;d(Pe.positions[g],Pe.positions[g+1],Pe.positions[g+2],-1)}ge.forEach((m,g)=>{if(!m.visible)return;const _=m.renderer.positions;for(let p=0;p<m.M;p++){const f=p*3;d(_[f],_[f+1],_[f+2],g)}});const h=35*35;u>=h&&(l=-999)}if(l!==-999){if(wi(l),H.editMode&&i.button===0){const d=(l===-1?Pe:ge[l].renderer).positions;let h=-1,m=Number.POSITIVE_INFINITY;const g=l===-1?Le:ge[l].M;for(let _=0;_<g;_++){const p=_*3;vt.set(d[p],d[p+1],d[p+2]).project(st);const f=(vt.x*.5+.5)*r,y=(-vt.y*.5+.5)*s,x=f-t,b=y-n,L=x*x+b*b;L<m&&(m=L,h=_)}zn=h,fl(l,h)}}else wi(gi),zn=-1,pt&&($e.remove(pt),pt=null),At&&($e.remove(At),At=null)});window.addEventListener("pointermove",i=>{if(je.active&&i.pointerId===je.pointerId){if(i.preventDefault(),Mn={x:i.clientX,y:i.clientY},!je.started){if(Math.hypot(i.clientX-je.startX,i.clientY-je.startY)<3)return;if(Hn(),mo(je.mode,new PointerEvent("pointerdown",{clientX:i.clientX,clientY:i.clientY})),je.started=I.mode!=="none",!je.started){je.active=!1,je.pointerId=-1,je.mode="none";return}Br()}Vd(i.clientX,i.clientY);return}if(!Pt.active)return;i.preventDefault();const e=i.clientX-Pt.lastX;Pt.lastX=i.clientX,Pt.accum+=e;const t=35;let n=0;for(;Pt.accum>t;)n++,Pt.accum-=t;for(;Pt.accum<-t;)n--,Pt.accum+=t;n!==0&&wd(n)});window.addEventListener("pointerup",i=>{var e;if(je.active&&i.pointerId===je.pointerId){(e=je.sourceButton)!=null&&e.hasPointerCapture(i.pointerId)&&je.sourceButton.releasePointerCapture(i.pointerId),je.started&&I.mode!=="none"&&po(!0),je.active=!1,je.started=!1,je.pointerId=-1,je.mode="none",je.sourceButton=null,i.preventDefault();return}i.button!==1||!Pt.active||(Pt.active=!1,Pt.accum=0,St.enableZoom=Pt.prevZoom,St.enablePan=Pt.prevPan)});window.addEventListener("pointercancel",i=>{var e;je.active&&i.pointerId===je.pointerId&&((e=je.sourceButton)!=null&&e.hasPointerCapture(i.pointerId)&&je.sourceButton.releasePointerCapture(i.pointerId),je.started&&I.mode!=="none"&&po(!1),je.active=!1,je.started=!1,je.pointerId=-1,je.mode="none",je.sourceButton=null)});window.addEventListener("keydown",i=>{const e=i.key.toLowerCase();if(!(i.ctrlKey||i.metaKey))return;const n=e==="z"&&!i.shiftKey,r=e==="y"||e==="z"&&i.shiftKey;if(!(!n&&!r)&&!Vx(i.target)&&I.mode==="none"){if(i.preventDefault(),n){const s=ts.pop();s&&(ka.push(Xa()),wu(s))}else if(r){const s=ka.pop();s&&(ts.push(Xa()),wu(s))}}});window.addEventListener("keydown",i=>{if(Rd(i.target)||I.mode==="none")return;const e=i.key.toLowerCase();if(e==="w"){I.mode==="rotate"&&(i.preventDefault(),I.wPlane=!I.wPlane,ho());return}(e==="x"||e==="y"||e==="z")&&(I.lockAxis=e==="x"?0:e==="y"?1:2,ho())});window.addEventListener("keydown",i=>{if(!Rd(i.target)&&(i.key==="Tab"&&(i.preventDefault(),Nd(!H.editMode)),I.mode==="none")){if(i.key==="g"||i.key==="r"||i.key==="s"){i.preventDefault();const e={g:"move",r:"rotate",s:"scale"},t=new PointerEvent("pointerdown",{clientX:Mn.x,clientY:Mn.y});mo(e[i.key],t)}else if(i.key.toLowerCase()==="a"&&i.shiftKey){if(i.preventDefault(),!tt)return;tt.innerHTML="";const e=[{label:"Hypercube",kind:"hypercube"},{label:"Cross polytope",kind:"cross"},{label:"Simplex",kind:"simplex"},{label:"Simplex prism",kind:"simplexPrism"}],t=Gd(new PointerEvent("pointerdown",{clientX:Mn.x,clientY:Mn.y}));e.forEach(n=>{const r=document.createElement("button");r.textContent=`Add ${n.label}`,r.onclick=()=>{tt.style.display="none",Hn();const s=rl(n.kind,H.N),a=ul(H.N),o=yo(s.verts,H.N,a),l=new ls($e);l.build(s.V,s.edges),Ar.copy(t);const c=new Float32Array(3*s.V),u=`${n.label} #${ge.length+1}`,d={pos:Ar.clone(),rot:new w,scale:new w(1,1,1)},h=Ti(hn);l.setSurface(h),ge.push({renderer:l,Y:c,X:o,E:s.edges,M:s.V,offset:Ar.clone(),label:u,kind:n.kind,transform:d,originalN:H.N,axisMap:a,visible:!0,surface:h}),Qn.project(o,s.V,c),l.setTransform(d.pos,new Dn(d.rot.x,d.rot.y,d.rot.z),d.scale),l.writeInterleavedFrom(c),l.filterEdgesByDimRange(o,zt,s.V,H.sliceDim,H.sliceMin,H.sliceMax),l.setMode(H.renderMode),mn(),En(),In()},tt.appendChild(r)}),tt.style.left=`${Mn.x}px`,tt.style.top=`${Mn.y}px`,tt.style.display="block"}else if(i.key==="x"){if(i.preventDefault(),!(ke===ln&&Le>0||ke>=0))return;On?(On=!1,tt&&(tt.style.display="none"),Id()):zd()}}});function kd(){const i=Math.min(f0.getDelta(),.05);i0(i),mn(),St.update(),Br(),Eo(),ot.render($e,st),requestAnimationFrame(kd)}kd();function mo(i,e){var t;if(ti(ke))if(I.mode=i,I.instIdx=ke,I.targetVertex=H.editMode?zn:-1,I.startMouse.set(e.clientX,e.clientY),I.targetVertex>=0){if(I.targetVertex<0){I.mode="none";return}const n=I.instIdx===-1?null:ge[I.instIdx],r=n?n.renderer.positions:Pe.positions,s=I.targetVertex*3;I.vertexStart.set(r[s],r[s+1],r[s+2]);const a=n?n.X:kt;I.vertexDataStart=new Float32Array(ze);for(let o=0;o<ze;o++)I.vertexDataStart[o]=a[o*(n?n.M:Le)+I.targetVertex];I.startScale=1,I.plane.setFromNormalAndCoplanarPoint(st.getWorldDirection(vt).normalize(),I.vertexStart),I.planeHitStart.copy(I.vertexStart),I.lastHit.copy(I.vertexStart),I.lockAxis=-1,I.wPlane=!1}else{const n=ke===ln?Ct:(t=ge[ke])==null?void 0:t.transform;if(!n)return;if(I.startPos.copy(n.pos),I.startRot.copy(n.rot),I.startScale=n.scale.x,I.lockAxis=-1,I.wPlane=!1,i==="move"||i==="rotate"){const r=ke===ln?kt:ge[ke].X,s=ke===ln?Le:ge[ke].M;if(I.objectDataStart=new Float32Array(r.length),I.objectDataStart.set(r),I.lastHit.set(0,0,0),i==="move"){const a=ke===ln?Pe.positions:ge[ke].renderer.positions,o=qa(a,s);I.planeHitStart.copy(o),I.plane.setFromNormalAndCoplanarPoint(st.getWorldDirection(vt).normalize(),o);const l=ot.domElement.getBoundingClientRect();pi.set((e.clientX-l.left)/l.width*2-1,-((e.clientY-l.top)/l.height)*2+1),fi.setFromCamera(pi,st);const c=fi.ray.intersectPlane(I.plane,vt);c?(I.lastHit.copy(c),I.moveOffset.copy(I.planeHitStart).sub(c)):(I.lastHit.copy(o),I.moveOffset.set(0,0,0))}}else I.objectDataStart=null}}window.addEventListener("resize",()=>{const i=window.innerWidth,e=window.innerHeight;st.aspect=i/e,st.updateProjectionMatrix(),ot.setSize(i,e),bo()});
